...
-- key	=>  Location: PIN_L23,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
...
SIGNAL \MUX|output[6]~15_combout\ : std_logic;
...
SIGNAL \MUX|output[10]~16_combout\ : std_logic;
...
SIGNAL \MUX|output[14]~17_combout\ : std_logic;
...
SIGNAL \MUX|output[16]~13_combout\ : std_logic;
SIGNAL \HEX4|out5~0_combout\ : std_logic;
SIGNAL \MUX|output[17]~14_combout\ : std_logic;
SIGNAL \MUX|ALT_INV_output[17]~14_combout\ : std_logic;
SIGNAL \HEX4|ALT_INV_out1~1_combout\ : std_logic;
...
ww_devclrn <= devclrn;
ww_devpor <= devpor;
\MUX|ALT_INV_output[17]~14_combout\ <= NOT \MUX|output[17]~14_combout\;
\HEX4|ALT_INV_out1~1_combout\ <= NOT \HEX4|out1~1_combout\;
...
-- pragma translate_on
PORT MAP (
	i => \MUX|ALT_INV_output[17]~14_combout\,
	devoe => ww_devoe,
...
-- Equation(s):
-- \HEX0|out3~4_combout\ = (!\MUX|output[1]~1_combout\ & (!\MUX|output[3]~0_combout\ & (\switches[2]~input_o\ $ (\switches[0]~input_o\))))
...
-- Equation(s):
-- \HEX0|out0~1_combout\ = (\HEX0|out3~4_combout\) # ((\HEX0|out0~0_combout\ & (\switches[2]~input_o\ $ (\switches[1]~input_o\))))
...
-- Equation(s):
-- \HEX0|out1~1_combout\ = (\HEX0|out0~0_combout\ & ((\MUX|output[1]~1_combout\) # ((\MUX|output[2]~2_combout\ & \HEX0|out1~0_combout\)))) # (!\HEX0|out0~0_combout\ & (\MUX|output[2]~2_combout\ & ((\HEX0|out1~0_combout\))))
...
-- Equation(s):
-- \HEX0|out3~5_combout\ = \switches[0]~input_o\ $ (\key~input_o\ $ (((!\switches[3]~input_o\ & \switches[2]~input_o\))))
...
-- Equation(s):
-- \HEX0|out3~6_combout\ = (\HEX0|out3~5_combout\ & (\switches[1]~input_o\ $ (((!\switches[3]~input_o\) # (!\switches[2]~input_o\))))) # (!\HEX0|out3~5_combout\ & (\switches[1]~input_o\ & (\switches[2]~input_o\ $ (\switches[3]~input_o\))))
...
-- Equation(s):
-- \HEX0|out5~2_combout\ = (\MUX|output[2]~2_combout\ & (!\MUX|output[1]~1_combout\ & (\HEX0|out0~0_combout\))) # (!\MUX|output[2]~2_combout\ & (((\HEX0|out5~3_combout\))))
...
-- Equation(s):
-- \MUX|output[4]~6_combout\ = \switches[4]~input_o\ $ (\key~input_o\)
...
-- Equation(s):
-- \HEX1|out3~4_combout\ = (!\MUX|output[7]~5_combout\ & (!\MUX|output[5]~4_combout\ & (\switches[6]~input_o\ $ (\switches[4]~input_o\))))
...
-- Equation(s):
-- \HEX1|out0~1_combout\ = (\HEX1|out3~4_combout\) # ((\MUX|output[4]~6_combout\ & (\HEX1|out0~0_combout\ & \MUX|output[7]~5_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \MUX|output[4]~6_combout\,
	datab => \HEX1|out0~0_combout\,
	datac => \MUX|output[7]~5_combout\,
	datad => \HEX1|out3~4_combout\,
	combout => \HEX1|out0~1_combout\);

-- Location: LCCOMB_X114_Y22_N4
\MUX|output[6]~15\ : cycloneive_lcell_comb
-- Equation(s):
-- \MUX|output[6]~15_combout\ = \switches[6]~input_o\ $ (\key~input_o\)
...
PORT MAP (
	datac => \switches[6]~input_o\,
	datad => \key~input_o\,
	combout => \MUX|output[6]~15_combout\);

-- Location: LCCOMB_X114_Y22_N8
\HEX1|out1~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \HEX1|out1~0_combout\ = (\switches[4]~input_o\ & ((\key~input_o\ & ((!\switches[6]~input_o\))) # (!\key~input_o\ & (\switches[5]~input_o\)))) # (!\switches[4]~input_o\ & ((\key~input_o\ & (!\switches[5]~input_o\)) # (!\key~input_o\ & 
-- ((\switches[6]~input_o\)))))
...
-- Equation(s):
-- \HEX1|out1~1_combout\ = (\MUX|output[7]~5_combout\ & (((\HEX1|out1~0_combout\)))) # (!\MUX|output[7]~5_combout\ & (\MUX|output[6]~15_combout\ & ((\HEX1|out1~2_combout\))))
...
PORT MAP (
	dataa => \MUX|output[7]~5_combout\,
	datab => \MUX|output[6]~15_combout\,
	datac => \HEX1|out1~0_combout\,
	datad => \HEX1|out1~2_combout\,
	combout => \HEX1|out1~1_combout\);

-- Location: LCCOMB_X114_Y22_N28
\HEX1|out2~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \HEX1|out2~0_combout\ = (\MUX|output[6]~15_combout\ & (\MUX|output[7]~5_combout\ & ((\MUX|output[5]~4_combout\) # (!\MUX|output[4]~6_combout\)))) # (!\MUX|output[6]~15_combout\ & (!\MUX|output[4]~6_combout\ & (!\MUX|output[7]~5_combout\ & 
...
-- Equation(s):
-- \HEX1|out3~5_combout\ = \switches[4]~input_o\ $ (\switches[5]~input_o\ $ (\switches[6]~input_o\ $ (\key~input_o\)))
...
-- Equation(s):
-- \HEX1|out4~0_combout\ = (\MUX|output[5]~4_combout\ & (\MUX|output[4]~6_combout\ & ((!\MUX|output[7]~5_combout\)))) # (!\MUX|output[5]~4_combout\ & ((\MUX|output[6]~15_combout\ & ((!\MUX|output[7]~5_combout\))) # (!\MUX|output[6]~15_combout\ & 
...
-- Equation(s):
-- \HEX1|out5~4_combout\ = (\switches[4]~input_o\ & ((\switches[6]~input_o\ & (!\switches[5]~input_o\)) # (!\switches[6]~input_o\ & ((!\key~input_o\))))) # (!\switches[4]~input_o\ & ((\switches[6]~input_o\ & ((\key~input_o\))) # (!\switches[6]~input_o\ & 
-- (\switches[5]~input_o\))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0111010000101110",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \switches[4]~input_o\,
...
-- Equation(s):
-- \HEX1|out6~0_combout\ = (\MUX|output[4]~6_combout\ & (!\MUX|output[7]~5_combout\ & (\MUX|output[6]~15_combout\ $ (!\MUX|output[5]~4_combout\)))) # (!\MUX|output[4]~6_combout\ & (!\MUX|output[5]~4_combout\ & (\MUX|output[6]~15_combout\ $ 
-- (!\MUX|output[7]~5_combout\))))
...
-- Equation(s):
-- \HEX2|out3~4_combout\ = (!\MUX|output[11]~8_combout\ & (!\MUX|output[9]~7_combout\ & (\switches[10]~input_o\ $ (\switches[8]~input_o\))))
...
PORT MAP (
	...
	datac => \MUX|output[11]~8_combout\,
	datad => \MUX|output[9]~7_combout\,
	combout => \HEX2|out3~4_combout\);

-- Location: LCCOMB_X114_Y16_N30
\HEX2|out0~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \HEX2|out0~1_combout\ = (\HEX2|out3~4_combout\) # ((\MUX|output[11]~8_combout\ & (\HEX2|out0~0_combout\ & \MUX|output[8]~9_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \MUX|output[11]~8_combout\,
	datab => \HEX2|out0~0_combout\,
	datac => \MUX|output[8]~9_combout\,
	datad => \HEX2|out3~4_combout\,
	combout => \HEX2|out0~1_combout\);

-- Location: LCCOMB_X114_Y16_N20
\MUX|output[10]~16\ : cycloneive_lcell_comb
-- Equation(s):
-- \MUX|output[10]~16_combout\ = \switches[10]~input_o\ $ (\key~input_o\)
...
PORT MAP (
	...
	datad => \key~input_o\,
	combout => \MUX|output[10]~16_combout\);

-- Location: LCCOMB_X114_Y16_N8
\HEX2|out1~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \HEX2|out1~0_combout\ = (\switches[9]~input_o\ & ((\switches[10]~input_o\ & ((!\key~input_o\))) # (!\switches[10]~input_o\ & (\switches[8]~input_o\)))) # (!\switches[9]~input_o\ & ((\switches[10]~input_o\ & (!\switches[8]~input_o\)) # 
-- (!\switches[10]~input_o\ & ((\key~input_o\)))))
...
-- Equation(s):
-- \HEX2|out1~1_combout\ = (\MUX|output[11]~8_combout\ & (((\HEX2|out1~0_combout\)))) # (!\MUX|output[11]~8_combout\ & (\MUX|output[10]~16_combout\ & ((\HEX2|out1~2_combout\))))
...
PORT MAP (
	dataa => \MUX|output[11]~8_combout\,
	datab => \MUX|output[10]~16_combout\,
	datac => \HEX2|out1~0_combout\,
	datad => \HEX2|out1~2_combout\,
	combout => \HEX2|out1~1_combout\);

-- Location: LCCOMB_X114_Y16_N12
\HEX2|out2~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \HEX2|out2~0_combout\ = (\MUX|output[11]~8_combout\ & (\MUX|output[10]~16_combout\ & ((\MUX|output[9]~7_combout\) # (!\MUX|output[8]~9_combout\)))) # (!\MUX|output[11]~8_combout\ & (!\MUX|output[10]~16_combout\ & (!\MUX|output[8]~9_combout\ & 
-- \MUX|output[9]~7_combout\)))
...
-- Equation(s):
-- \HEX2|out3~5_combout\ = \switches[9]~input_o\ $ (\switches[8]~input_o\ $ (\switches[10]~input_o\ $ (\key~input_o\)))
...
-- Equation(s):
-- \HEX2|out3~6_combout\ = (\HEX2|out3~5_combout\ & ((\switches[9]~input_o\ & ((\switches[11]~input_o\) # (\switches[10]~input_o\))) # (!\switches[9]~input_o\ & ((!\switches[10]~input_o\) # (!\switches[11]~input_o\)))))
...
PORT MAP (
	...
	datab => \switches[11]~input_o\,
	datac => \switches[10]~input_o\,
	datad => \HEX2|out3~5_combout\,
	combout => \HEX2|out3~6_combout\);

-- Location: LCCOMB_X114_Y16_N22
\HEX2|out4~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \HEX2|out4~0_combout\ = (\MUX|output[9]~7_combout\ & (!\MUX|output[11]~8_combout\ & ((\MUX|output[8]~9_combout\)))) # (!\MUX|output[9]~7_combout\ & ((\MUX|output[10]~16_combout\ & (!\MUX|output[11]~8_combout\)) # (!\MUX|output[10]~16_combout\ & 
...
-- Equation(s):
-- \HEX2|out5~4_combout\ = (\switches[9]~input_o\ & ((\key~input_o\ & (!\switches[8]~input_o\)) # (!\key~input_o\ & ((!\switches[10]~input_o\))))) # (!\switches[9]~input_o\ & ((\key~input_o\ & ((\switches[10]~input_o\))) # (!\key~input_o\ & 
-- (\switches[8]~input_o\))))
...
-- Equation(s):
-- \HEX2|out6~0_combout\ = (\MUX|output[8]~9_combout\ & (!\MUX|output[11]~8_combout\ & (\MUX|output[10]~16_combout\ $ (!\MUX|output[9]~7_combout\)))) # (!\MUX|output[8]~9_combout\ & (!\MUX|output[9]~7_combout\ & (\MUX|output[11]~8_combout\ $ 
-- (!\MUX|output[10]~16_combout\))))
...
-- Equation(s):
-- \MUX|output[12]~12_combout\ = \switches[12]~input_o\ $ (\key~input_o\)
...
-- Equation(s):
-- \HEX3|out0~0_combout\ = \switches[13]~input_o\ $ (\switches[14]~input_o\)
...
-- Equation(s):
-- \MUX|output[15]~11_combout\ = \key~input_o\ $ (\switches[15]~input_o\)
...
-- Equation(s):
-- \HEX3|out3~4_combout\ = (!\MUX|output[15]~11_combout\ & (!\MUX|output[13]~10_combout\ & (\switches[14]~input_o\ $ (\switches[12]~input_o\))))
...
PORT MAP (
	...
	datac => \MUX|output[13]~10_combout\,
...
-- Equation(s):
-- \HEX3|out1~0_combout\ = (\switches[14]~input_o\ & ((\switches[13]~input_o\ & ((!\key~input_o\))) # (!\switches[13]~input_o\ & (!\switches[12]~input_o\)))) # (!\switches[14]~input_o\ & ((\switches[13]~input_o\ & (\switches[12]~input_o\)) # 
-- (!\switches[13]~input_o\ & ((\key~input_o\)))))
...
PORT MAP (
	...
	datab => \switches[12]~input_o\,
	datac => \key~input_o\,
	datad => \switches[13]~input_o\,
	combout => \HEX3|out1~0_combout\);

-- Location: LCCOMB_X108_Y4_N24
\MUX|output[14]~17\ : cycloneive_lcell_comb
-- Equation(s):
-- \MUX|output[14]~17_combout\ = \key~input_o\ $ (\switches[14]~input_o\)
...
PORT MAP (
	datab => \key~input_o\,
	datac => \switches[14]~input_o\,
	combout => \MUX|output[14]~17_combout\);
...
-- Equation(s):
-- \HEX3|out1~1_combout\ = (\MUX|output[15]~11_combout\ & (\HEX3|out1~0_combout\)) # (!\MUX|output[15]~11_combout\ & (((\MUX|output[14]~17_combout\ & \HEX3|out1~2_combout\))))
...
PORT MAP (
	...
	datab => \MUX|output[14]~17_combout\,
	datac => \HEX3|out1~2_combout\,
	datad => \MUX|output[15]~11_combout\,
...
-- Equation(s):
-- \HEX3|out2~0_combout\ = (\MUX|output[15]~11_combout\ & (\MUX|output[14]~17_combout\ & ((\MUX|output[13]~10_combout\) # (!\MUX|output[12]~12_combout\)))) # (!\MUX|output[15]~11_combout\ & (!\MUX|output[14]~17_combout\ & (\MUX|output[13]~10_combout\ & 
...
-- pragma translate_on
PORT MAP (
	dataa => \MUX|output[15]~11_combout\,
	datab => \MUX|output[14]~17_combout\,
	datac => \MUX|output[13]~10_combout\,
	datad => \MUX|output[12]~12_combout\,
	combout => \HEX3|out2~0_combout\);

-- Location: LCCOMB_X108_Y4_N8
\HEX3|out3~5\ : cycloneive_lcell_comb
-- Equation(s):
-- \HEX3|out3~5_combout\ = \switches[14]~input_o\ $ (\switches[12]~input_o\ $ (\key~input_o\ $ (\switches[13]~input_o\)))
...
-- Equation(s):
-- \HEX3|out3~6_combout\ = (\HEX3|out3~5_combout\ & ((\switches[15]~input_o\ & ((\switches[13]~input_o\) # (!\switches[14]~input_o\))) # (!\switches[15]~input_o\ & ((\switches[14]~input_o\) # (!\switches[13]~input_o\)))))
...
-- Equation(s):
-- \HEX3|out4~0_combout\ = (\MUX|output[13]~10_combout\ & (!\MUX|output[15]~11_combout\ & ((\MUX|output[12]~12_combout\)))) # (!\MUX|output[13]~10_combout\ & ((\MUX|output[14]~17_combout\ & (!\MUX|output[15]~11_combout\)) # (!\MUX|output[14]~17_combout\ & 
-- ((\MUX|output[12]~12_combout\)))))
...
-- Equation(s):
-- \HEX3|out5~4_combout\ = (\switches[14]~input_o\ & ((\switches[12]~input_o\ & ((!\switches[13]~input_o\))) # (!\switches[12]~input_o\ & (\key~input_o\)))) # (!\switches[14]~input_o\ & ((\switches[12]~input_o\ & (!\key~input_o\)) # (!\switches[12]~input_o\ 
-- & ((\switches[13]~input_o\)))))
...
-- Equation(s):
-- \HEX3|out6~0_combout\ = (\MUX|output[12]~12_combout\ & (!\MUX|output[15]~11_combout\ & (\MUX|output[14]~17_combout\ $ (!\MUX|output[13]~10_combout\)))) # (!\MUX|output[12]~12_combout\ & (!\MUX|output[13]~10_combout\ & (\MUX|output[15]~11_combout\ $ 
-- (!\MUX|output[14]~17_combout\))))
...
-- Equation(s):
-- \HEX4|out1~1_combout\ = (\switches[16]~input_o\ & ((\switches[17]~input_o\) # (!\key~input_o\))) # (!\switches[16]~input_o\ & ((\key~input_o\) # (!\switches[17]~input_o\)))
...
\MUX|output[16]~13\ : cycloneive_lcell_comb
-- Equation(s):
-- \MUX|output[16]~13_combout\ = \switches[16]~input_o\ $ (\key~input_o\)
...
PORT MAP (
	datab => \switches[16]~input_o\,
	datad => \key~input_o\,
	combout => \MUX|output[16]~13_combout\);

-- Location: LCCOMB_X107_Y4_N12
\HEX4|out5~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \HEX4|out5~0_combout\ = (\switches[16]~input_o\ & ((!\key~input_o\) # (!\switches[17]~input_o\))) # (!\switches[16]~input_o\ & ((\switches[17]~input_o\) # (\key~input_o\)))
...
\MUX|output[17]~14\ : cycloneive_lcell_comb
-- Equation(s):
-- \MUX|output[17]~14_combout\ = \switches[17]~input_o\ $ (\key~input_o\)
...
PORT MAP (
	datac => \switches[17]~input_o\,
	datad => \key~input_o\,
	combout => \MUX|output[17]~14_combout\);
